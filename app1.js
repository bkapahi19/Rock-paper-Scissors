...
const userScoreP1 = document.querySelector("#user-score");
const compScoreP1 = document.querySelector("#comp-score");
...
const showWinner = (userWin,userChoice,compChoice) =>{
    if(userWin){
        userScore++;
        userScoreP1.innerText=userScore;
        msg.innerText=`You win! Your ${userChoice} beats ${compChoice}`;
        msg.backgroundcolor = "green";
    }else{
        compScore++;
        compScoreP1.innerText=compScore;
